...
#spawn constants
spawn_upper_xlimit = 1000
spawn_lower_xlimit = 550
...
#movies
intro_movie = './img/Screen0/intro_video.mp4'
...
def main():
    ...
    pygame.display.set_caption("Monkey Fever") #FIXME: delete this
    ...
    #pygame.time.set_timer(pygame.USEREVENT, 1000) #this causes the key pool to stuck
    #font = pygame.font.SysFont('Consolas', 30)
    font = pygame.font.Font('./font/Neolion.otf',24)
    timertext = -99

    #enemies, soldiers and landscapes
    #enemy0 = ClassEnemy(551,429,0)
    enemy0 = ClassEnemy(-999,429,0)
    enemy1 = ClassEnemy(-999,429,1)
    soldier = ClassSoldier(150,750)
    sight = ClassSight()
    ...
    enemy0.generateSequence(0);enemy0.order = "none"
    enemy1.generateSequence(1);enemy1.order = "none"
    ...
    while going:
        ...
        Global_SightTriggerPulled = False #FIXME: delete ths one
        ...
        if pointer == 0:
            ...
            #FIXME: add here the intro movie
            ...
            print("Running level0") #FIXME: this could be deleted after testing
        elif pointer == 3:
        ...
        if pointer == 3 or pointer == 4:
            ...
            screen.blit(Wall, (380, 350))  #draw  wall
            soldiersprite.draw(screen)
            sgtsprite.draw(screen)
            screen.blit(font.render(str(timertext), True, (0, 0, 0)), (32, 48))
            screen.blit(font.render("kills"+str(kills), True, (0, 0, 0)), (32, 60))
            pygame.display.update()
